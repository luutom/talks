...
## Zeroth order in $\tilde V\propto U$
:::{style='font-size:70%'}
...
So to order $\mathcal{O}(\tilde V\propto U)$ there is not contribution to the energy shift for both ground state and single particle state (above the ground state).
:::
