...
& b^\dagger_{-d,s}|\Omega\rangle &  & & S=\frac{1}{2} && S_z=\pm\frac{1}{2} && Q=-1 && \Pi=??\\
& a^\dagger_{d,s}b^\dagger_{-d,\uparrow}b^\dagger_{-d,\downarrow}|\Omega\rangle &  & & S=\frac{1}{2} && S_z=\pm\frac{1}{2} && Q=-1 && \Pi=??\\
...
& b^\dagger_{-d,s}a^\dagger_{d,\uparrow}a^\dagger_{d,\downarrow}|\Omega\rangle &  & & S=\frac{1}{2} && S_z=\pm\frac{1}{2} && Q=+1 && \Pi=??\\
& a^\dagger_{d,s}|\Omega\rangle &  & & S=\frac{1}{2} && S_z=\pm\frac{1}{2} && Q=+1 && \Pi=??\\
...
All these states have eigenenergy $\mathcal{E}_\Omega-\frac{U}{2}\Lambda$, but they have different total spin $S$ (if known), spin projection $S_z$, charge $Q$, and parity $\Pi$ (if known) as labelled above. 
...
If $V_{d,-d;-d,-d}=V_{-d,-d;-d,d}$ then the diagonalization of this matrix is trivial.  I will confirm this later.  Also note that parities are mixed in this case.
:::
