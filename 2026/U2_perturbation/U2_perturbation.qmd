...
$$
c^\dagger_{d,s,+}|0\rangle \equiv a^\dagger_{+d,s}|0\rangle\quad;\quad c^\dagger_{d,s,-}|0\rangle\equiv a^\dagger_{-d,s}|0\rangle
$$
...
$$
Notice that ***none*** of the degenerate states are included in the defintion of $|\mathcal{V}\rangle$.  $H_1$ slightly changes

:::{style='font-size:70%'}
$$
H_1=-\frac{U}{2}\left(\sum_{k\ s.t.\ \epsilon_k\ge 0,s}a^{\dagger}_{k,s}a^{}_{k,s}-\sum_{k\ s.t.\ \epsilon_k<0,s}b^{\dagger}_{-k,s}b^{}_{-k,s}\right)-U\left(\Lambda-1\right)\ .
$$
:::

---

Because of these single-particle degenerate states, we now have ***many*** *many*-body non-interacting degenerate states

:::{style='font-size: 0.7em'}
$$
\begin{align}
 & &|\mathcal{V}\rangle & & S=0 &&  S_z=0 && Q=-2 && \Pi=+1\\
a^\dagger_{d,s}|\mathcal{V}\rangle & & a^\dagger_{-d,s}|\mathcal{V}\rangle & & S=\frac{1}{2} && S_z=\pm\frac{1}{2} && Q=-1 && \Pi=\pm 1\\
a^\dagger_{d,\uparrow}a^\dagger_{-d,\uparrow}|\mathcal{V}\rangle & &  & & S=1 && S_z=+1 && Q=0 && \Pi=-1\\
 & \frac{1}{\sqrt{2}}\left(a^\dagger_{d,\uparrow}a^\dagger_{-d,\downarrow}+a^\dagger_{d,\downarrow}a^\dagger_{-d,\uparrow}\right)|\mathcal{V}\rangle &  & & S=1 && S_z=0 && Q=0 && \Pi=-1\\
 & & a^\dagger_{d,\downarrow}a^\dagger_{-d,\downarrow}|\mathcal{V}\rangle & & S=1 && S_z=-1 && Q=0 && \Pi=-1\\
 & \frac{1}{\sqrt{2}}\left(a^\dagger_{d,\uparrow}a^\dagger_{-d,\downarrow}-a^\dagger_{d,\downarrow}a^\dagger_{-d,\uparrow}\right)|\mathcal{V}\rangle &  & & S=0 && S_z=0 && Q=0 && \Pi=-1\\
  & \frac{1}{\sqrt{2}}\left(a^\dagger_{d,\uparrow}a^\dagger_{d,\downarrow}-a^\dagger_{-d,\downarrow}a^\dagger_{-d,\uparrow}\right)|\mathcal{V}\rangle &  & & S=0 && S_z=0 && Q=0 && \Pi=+1\\
    & \frac{1}{\sqrt{2}}\left(a^\dagger_{d,\uparrow}a^\dagger_{d,\downarrow}+a^\dagger_{-d,\downarrow}a^\dagger_{-d,\uparrow}\right)|\mathcal{V}\rangle &  & & S=?? && S_z=0 && Q=0 && \Pi=+1
\end{align}
$${#eq-states16}
:::
...
All these states have eigenenergy $\mathcal{E}_\mathcal{V}-\frac{U}{2}\Lambda$, but they have different total spin $S$, spin projection $S_z$, charge $Q$, and parity $\Pi$ as labelled above. I only show the $Q=-2,\ -1$ and $0$ states. I will consider the $Q=1$ and $2$ states later.
...
To perform degenerate perturbation theory at leading order, I need to diagonalize within the different $Q,\ S_z$, and $\Pi$ subspaces.

#### $Q=-2$

I start with $Q=-2$ space and work my way up.
It is trivial to see that
$$
\langle \mathcal{V}|\tilde V|\mathcal{V}\rangle=0
$$

#### $Q=-1$

I believe it is also trivial to see that
$$
\langle\mathcal{V}|a^{}_{\sigma d,s}\tilde Va^\dagger_{\sigma' d,s'}|\mathcal{V}\rangle=0
$$
...
Instead of using the $Q=1$ states defined in @eq-states16, I will build these states from the newly found half-filled states $|\Omega_\pm\rangle$,
$$
\begin{align}
a^\dagger_{+d,s}|\Omega_+\rangle &\quad; & a^\dagger_{-d,s}|\Omega_-\rangle &\quad; & \Pi=+1\\
a^\dagger_{-d,s}|\Omega_+\rangle &\quad; & a^\dagger_{+d,s}|\Omega_-\rangle &\quad; & \Pi=-1
\end{align}
$$
