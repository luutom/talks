...
The interaction $\tilde V$ does not violate the $S$, $S_z$, and $Q$ quantum numbers^[It seems that $\tilde V$ will mix parities.]. 
...
I will just consider $S_z=\frac{1}{2}$.  Here is the basis and matrix

:::{style='font-size: 0.7em'}
\begin{equation}
\left\lvert Q=-1;S_z=\frac{1}{2}\right\rangle=
\begin{pmatrix}
b^\dagger_{-d,\downarrow}|\Omega\rangle\\
