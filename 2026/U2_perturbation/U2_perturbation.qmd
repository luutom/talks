...
I assume there are degenerate single-particle states whose energy $\epsilon_d=0$.  The systems we are interested in (ie armchair ribbons), if they have a zero energy, will have a degeneracy of 4 (2 for spin, and 2 for band).  I label these single-paricle degenerate states as^[The labels $a$ and $b$ for these degenerate states are completely arbitrary.]
$$
a^\dagger_{d,s}|0\rangle\quad;\quad b^{}_{-d,s}|0\rangle
$$
where $d$ denotes the degenerate state and $s=\uparrow,\downarrow$.

I again define the ground state $|\Omega\rangle$
$$
|\Omega\rangle=\left(\prod_{-k,s}b_{-k,s}\right)|0\rangle
$$
Notice that I ***include*** the $b^{}_{-d,s}$ states that have zero energy in the definition of the ground state $|\Omega\rangle$.
...
$$
\begin{align}
a^\dagger_{d,s}|\Omega\rangle & & b^\dagger_{-d,s}|\Omega\rangle & & S_z=\pm\frac{1}{2}\\
a^\dagger_{d,s}b^\dagger_{-d,\downarrow}b^\dagger_{-d,\uparrow}|\Omega\rangle & & b^\dagger_{-d,s}a^\dagger_{d,\uparrow}a^\dagger_{d,\downarrow}|\Omega\rangle & & S_z=\pm\frac{1}{2} \\
a^\dagger_{d,\uparrow}b^\dagger_{-d,\uparrow}|\Omega\rangle & & a^\dagger_{d,\downarrow}b^\dagger_{-d,\downarrow}|\Omega\rangle & & S_z=\pm 1\\
a^\dagger_{d,\uparrow}a^\dagger_{d,\downarrow}|\Omega\rangle & & a^\dagger_{d,\downarrow}b^\dagger_{-d,\uparrow}|\Omega\rangle & & S_z=0\\
a^\dagger_{d,\uparrow}b^\dagger_{-d,\downarrow}|\Omega\rangle & & b^\dagger_{-d,\downarrow}b^\dagger_{-d,\uparrow}|\Omega\rangle & & S_z=0\\
a^\dagger_{d,\uparrow}a^\dagger_{d,\downarrow}b^\dagger_{-d,\downarrow}b^\dagger_{-d,\uparrow}|\Omega\rangle & &|\Omega\rangle & &  S_z=0
\end{align}
$$
All these states have eigenenergy $\mathcal{E}_\Omega$ ($-\frac{U}{2}\Lambda$), but they have different $S_z$ as labelled above.
...
I will consider $S_z=0$ first.

Here I have to diagonalize the following matrix
$$
$$
