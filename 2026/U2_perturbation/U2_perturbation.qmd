...
\begin{equation}
\frac{1}{2}\left(E_1+E_{aabb}\pm\sqrt{(E_1-E_{aabb})^2+4V_{d,d;d,d}^2}\right)
\end{equation}

When $N_U\to\infty$ the eigenvalues go to $E_1$ and $E_{aabb}$ with eigenvectors $|\Omega\rangle$ and $a^\dagger_{d,\uparrow}a^\dagger_{d,\downarrow}b^\dagger_{-d,\uparrow}b^\dagger_{-d,\downarrow}|\Omega\rangle$, respectively.
