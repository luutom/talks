...
$$
a^\dagger_{d,s}|0\rangle\quad;\quad b^{}_{-d,s}|0\rangle
$$
where $d$ denotes the degenerate state and $s=\uparrow,\downarrow$.
...
Because of these single-particle degenerate states, we now have 16 *many*-body non-interacting degenerate states^[Remember that creation $b^\dagger_\uparrow$ of a hole with spin $\uparrow$, for example, actually results in a system with spin $\downarrow$!]
$$
\begin{align}
a^\dagger_{d,s}|\mathcal{V}\rangle & & b^{}_{-d,s}|\mathcal{V}\rangle & & S_z=\pm\frac{1}{2}\\
a^\dagger_{d,s}b^{}_{-d,\downarrow}b^{}_{-d,\uparrow}|\mathcal{V}\rangle & & a^\dagger_{d,\uparrow}a^\dagger_{d,\downarrow}b^{}_{-d,s}|\mathcal{V}\rangle & & S_z=\pm\frac{1}{2} \\
a^\dagger_{d,\uparrow}b^{}_{-d,\uparrow}|\mathcal{V}\rangle & & a^\dagger_{d,\downarrow}b^{}_{-d,\downarrow}|\mathcal{V}\rangle & & S_z=\pm 1\\
a^\dagger_{d,\uparrow}a^\dagger_{d,\downarrow}|\mathcal{V}\rangle & & b^{}_{-d,\uparrow}b^{}_{-d,\downarrow}|\mathcal{V}\rangle & & S_z=0\\
a^\dagger_{d,\uparrow}b^{}_{-d,\downarrow}|\mathcal{V}\rangle & & a^\dagger_{d,\downarrow}b^{}_{-d,\uparrow}|\mathcal{V}\rangle & & S_z=0\\
a^\dagger_{d,\uparrow}a^\dagger_{d,\downarrow}b^{}_{-d,\downarrow}b^{}_{-d,\uparrow}|\mathcal{V}\rangle & &|\mathcal{V}\rangle & &  S_z=0
\end{align}
$$
All these states have eigenenergy $\mathcal{E}_\mathcal{V}-\frac{U}{2}\Lambda$, but they have different $S_z$ as labelled above.
...
\begin{pmatrix}
 ...
 a^\dagger_{d,\uparrow}b^{}_{-d,\uparrow}|\mathcal{V}\rangle\\
 a^\dagger_{d,\downarrow}b^{}_{-d,\downarrow}|\mathcal{V}\rangle 
\end{pmatrix}
$$
This gives
$$
...
0 & 0 & V_{ d, d; d, d} & 0 & 0 & 0\\
0 & 0 & 0 & V_{-d,-d;-d,-d} & 0 & 0\\
