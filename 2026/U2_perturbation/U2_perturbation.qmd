...
All these states have eigenenergy $\mathcal{E}_\mathcal{V}-\frac{U}{2}\Lambda$, but they have different spin projection $S_z$, charge $Q$, and parity $\Pi$ as labelled above. I only show the $Q=-2,\ -1$ and $0$ states. I will consider the $Q=1$ and $2$ states later.
