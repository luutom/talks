...
$$
\langle \Omega|\tilde H_0|\Omega\rangle=\langle\Omega|\epsilon_{k}a^{\dagger}_{k,s}a^{}_{k,s}-\epsilon_{-k}b^{\dagger}_{-k,s}b^{}_{-k,s}+\mathcal{E}_{\Omega}-\frac{U}{2}\Lambda|\Omega\rangle=\mathcal{E}_{\Omega}-\frac{U}{2}\Lambda\equiv E_\Omega
$$

### Single-particle state $|k,s\rangle$
...
$$
\langle k,s|\tilde H_0|k,s\rangle=\langle k,s|\epsilon_{k}a^{\dagger}_{k,s}a^{}_{k,s}-\epsilon_{-k}b^{\dagger}_{-k,s}b^{}_{-k,s}+\mathcal{E}_{\Omega}-\frac{U}{2}\Lambda|k,s\rangle=\epsilon_k+\mathcal{E}_{\Omega}-\frac{U}{2}\Lambda\equiv E_{k,s}
$$

:::{.callout-note}
## Energy difference at $\mathcal{O}(V^0)$
$\therefore\quad$ the energy difference $E_{k,s}-E_\Omega=\epsilon_k$
:::
...
$$
|n\rangle=a^{\dagger}_{l,\uparrow}a^{\dagger}_{k,\downarrow}b^{\dagger}_{-l',\downarrow}b^{\dagger}_{-k',\uparrow}|\Omega\rangle
