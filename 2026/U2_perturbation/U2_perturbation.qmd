...
\begin{equation}
=\sum_{k',l\ne d, l'}\frac{V_{-l,d;l',k'}V_{k',l';d,-l}}{\epsilon_{-l}-\epsilon_{l'}-\epsilon_{k'}}
\end{equation}

---

+ (4,3) gives the same as (5,2):
...
+ (9,9) gives the same as (8,8):

\begin{equation}
=\sum_{l, l'}\frac{V_{-l,d;-d,l'}V_{l',-d;d,-l}}{\epsilon_{-l}-\epsilon_{l'}}
\end{equation}
