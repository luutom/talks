...
\title{Perturbative tubes}
\author{Thomas Luu}
\date{}
\begin{document}
\maketitle
\begin{abstract}
I document my efforts to calculate the tubes in perturbation theory
\end{abstract}
...
only (i.e.~Tight-binding model). I now expand the quadratic term giving
...
\subsubsection{Two-body excitation}\label{two-body-excitation}

Any two-body excitation of the form
\(b^\dagger_{-p_1,\sigma}a^\dagger_{p_2,\sigma'}|\Omega\rangle\) will
have energy
...
\(\therefore\quad\) the two-body excitation energy difference
\(E^{(0)}_{p_1,p_2}-E^{(0)}_\Omega=-\epsilon_{-p_1}+\epsilon_{p_2}=\epsilon_{p_1}+\epsilon_{p_2}\).
...
\subsubsection{Two-body excitations}\label{two-body-excitations}

To build all two-body excitations, I first perform an intermediate step
to obtain the following\footnote{All repeated indices are summed!}

\begin{equation}\protect\phantomsection\label{eq-Vstate}{
\begin{split}
...
As an example, I calculate the LO shift for the
\(|I=0,S=1,S_z=1\rangle=\frac{1}{\sqrt{2}}\left(a^\dagger_{p_1,\uparrow}b^\dagger_{-p_2,\downarrow}-b^\dagger_{-p_1,\downarrow}a^\dagger_{p_2,\uparrow}\right)|\Omega\rangle\)
state. I have
...
\(|I=1,I_z=0,S=1,S_z=1\rangle=\frac{1}{\sqrt{2}}\left(a^\dagger_{p_1,\uparrow}b^\dagger_{-p_2,\downarrow}+b^\dagger_{-p_1,\downarrow}a^\dagger_{p_2,\uparrow}\right)|\Omega\rangle\)
state gives
...
After some calculations\footnote{Petar, please confirm!!}, I get the
following LO shifts
...
\bottomrule\noalign{}
\endlastfoot
\(S_z=0\) & \(+2V_{p_1,p_1;p_2,p_2}\) & \(+2V_{p_1,p_1;p_2,p_2}\) &
\(+2V_{p_1,p_1;p_2,p_2}\) \\
\end{longtable}
}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Energy difference at \(\mathcal{O}(V)\) when \(p_1\ne p_2\)}, titlerule=0mm, toprule=.15mm, toptitle=1mm]

\(\therefore\quad\) the energy differences
\(E^{(1)}_{p_1,p_2}-E^{(1)}_\Omega\) are the following:

\begin{itemize}
\item
  \(I=1,\ S=0\ \):
  \(\ \epsilon_{p_1}+\epsilon_{p_2}+2V_{p_1,p_1;p_2,p_2}\)
\item
...
The results above are valid when \(p_1\ne p_2\). When \(p_1=p_2\) a
quick calculation gives\footnote{The \(I=0,\ S=0\) and \(I=1,\ S=1\)
  channels vanish when \(p_1=p_2=p\).}

\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Energy difference at \(\mathcal{O}(V)\) when \(p_1=p_2=p\)}, titlerule=0mm, toprule=.15mm, toptitle=1mm]

\(\therefore\quad\) the energy differences
\(E^{(1)}_{p,p}-E^{(1)}_\Omega\) are the following:
...
\subsubsection{\texorpdfstring{Two-body excitations
(\(p_1\ne p_2\))}{Two-body excitations (p\_1\textbackslash ne p\_2)}}\label{two-body-excitations-p_1ne-p_2}
...
This result is independent of \(S_z\) \textbf{\emph{and}} \(I_z\)!
...
This result is \textbf{\emph{independent}} of \(I_z\) and is exactly the
same as \(I=0,\ S=1\).

\subsubsection{\texorpdfstring{Two-body excitations
(\(p_1= p_2=p\))}{Two-body excitations (p\_1= p\_2=p)}}\label{two-body-excitations-p_1-p_2p}

When \(p_1=p_2=p\), only the channels \(I=0,\ S=1\) and \(I=1,\ S=0\)
have non-trivial results, since the interpolating operators for the
\(I=1,\ S=1\) and \(I=0\ ,S=0\) channels vanish due to anti-commutation
relations. Furthermore, the non-trivial results for \(I=0,\ S=1\) and
\(I=1,\ S=0\) are the same
...
\item
  \(I=1,\ S=0\ \):
  \(\ \epsilon_{p_1}+\epsilon_{p_2}+2V_{p_1,p_1;p_2,p_2}+\frac{V_{-p_1,l,m,n}^2}{-\epsilon _l-\epsilon _m-\epsilon _n+\epsilon _{p_1}}-\frac{V_{p_1,l,m,n}^2}{-\epsilon _l-\epsilon _m-\epsilon _n-\epsilon _{p_1}}+\frac{V_{-p_2,l,m,n}^2}{-\epsilon _l-\epsilon _m-\epsilon _n+\epsilon
   _{p_2}}-\frac{V_{p_2,l,m,n}^2}{-\epsilon _l-\epsilon _m-\epsilon _n-\epsilon _{p_2}}
   -\frac{V_{-p_1,p_2,m,n}^2}{-\epsilon _m-\epsilon _n+\epsilon _{p_1}-\epsilon _{p_2}}-\frac{V_{-p_1,p_2,m,n}^2}{-\epsilon _m-\epsilon _n-\epsilon _{p_1}+\epsilon _{p_2}}+\frac{2 V_{p_1,p_2,m,n}^2}{-\epsilon _m-\epsilon
   _n-\epsilon _{p_1}-\epsilon _{p_2}}+\frac{2 V_{p_1,p_2,m,n}^2}{-\epsilon _m-\epsilon _n+\epsilon _{p_1}+\epsilon _{p_2}}-\frac{2 V_{-p_1,p_1,m,n} V_{-p_2,p_2,m,n}}{-\epsilon _m-\epsilon _n}\)
\item
  \(I=1,\ S=1\ \):
  \(\ \epsilon_{p_1}+\epsilon_{p_2}+0+\frac{V_{-p_1,l,m,n}^2}{-\epsilon _l-\epsilon _m-\epsilon _n+\epsilon
   _{p_1}}-\frac{V_{p_1,l,m,n}^2}{-\epsilon _l-\epsilon _m-\epsilon _n-\epsilon _{p_1}}+\frac{V_{-p_2,l,m,n}^2}{-\epsilon _l-\epsilon _m-\epsilon _n+\epsilon
   _{p_2}}-\frac{V_{p_2,l,m,n}^2}{-\epsilon _l-\epsilon _m-\epsilon _n-\epsilon _{p_2}}
   -\frac{V_{-p_1,p_2,m,n}^2}{-\epsilon _m-\epsilon _n+\epsilon _{p_1}-\epsilon
   _{p_2}}-\frac{V_{-p_1,p_2,m,n}^2}{-\epsilon _m-\epsilon _n-\epsilon _{p_1}+\epsilon _{p_2}}+\frac{2 V_{-p_1,p_1,m,n} V_{-p_2,p_2,m,n}}{-\epsilon _m-\epsilon _n}\)
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Energy difference at \(\mathcal{O}(V^2)\) when \(p_1=p_2=p\)}, titlerule=0mm, toprule=.15mm, toptitle=1mm]
...
\item
  \(I=1,\ S=0\ \):
  \(\ 2\epsilon_{p}+V_{p,p;p,p}+\frac{2 V_{-p,l,m,n}^2}{-\epsilon _k-\epsilon _l-\epsilon _m+\epsilon _p}-\frac{2 V_{p,l,m,n}^2}{-\epsilon _l-\epsilon _m-\epsilon _n-\epsilon _p}
  -\frac{2 V_{-p,p,m,n}^2}{-\epsilon _m-\epsilon _n}+\frac{V_{p,p,m,n}^2}{-\epsilon _m-\epsilon
   _n-2 \epsilon _p}+\frac{V_{p,p,m,n}^2}{-\epsilon _m-\epsilon _n+2 \epsilon _p}\)
\item
  \(I=0,\ S=1\ \):
...
\subsubsection{Benchmarking with exact
results}\label{benchmarking-with-exact-results}

\begin{center}
\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio]{assets/2sites.png}
\end{center}

\begin{center}
\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio]{assets/4sites.png}
\end{center}

\subsection{Degenerate perturbation theory for
tubes}\label{degenerate-perturbation-theory-for-tubes}

For Petar's tubes, e.g.~(10,2), (9,4), (8,6), etc., there is an
additional complication coming from the fact that the lowest
single-particle conduction band energy is two-fold degenerate, and the
highest valence energy is also two-fold degenerate. This means that one
must, in principle, resort to degenerate perturbation theory for
two-body excitations involving these states. So let's do this.

I will denote the two degenerate conduction band energies by indices
\(p_1,p_2\), and the two degenerate valence energies as \(-p_1, -p_2\).
The first step in degenerate perturbation theory is to diagonalize the
leading order (in \(\tilde V\)) contribution in the basisi of degenerate
states. Since I know that the Hubbard interaction preserves net spin and
net iso(pseudo)spin, I can just focus on specific \(I_z,S_z\) cases.

I first consider the \(I_z=0\), \(S_z=1\) sector. The degenerate states
that span this subspace are
...
All these states have non-interacting energies
\(\epsilon_{p_1}+\epsilon_{p_2}=\epsilon_{p_1}+\epsilon_{p_1}=\epsilon_{p_2}+\epsilon_{p_2}=2\epsilon_{p_1}\).
...
Here I used the fact that \(V_{p_2,p_2,p_2,p_2}=V_{p_1,p_1,p_1,p_1}\)
and \(V_{\pm p_i,p_j,p_j,p_j}=0\). Diagonalizing this matrix gives the
following eigenvalues/eigenvectors

\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{\(I_z=0,\ S_z=1\)}, titlerule=0mm, toprule=.15mm, toptitle=1mm]
...
Now consider \(I_z=1,\  S_z=0\). The degenerate states that span this
subspace are
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{\(I_z=1,\ S_z=0\)}, titlerule=0mm, toprule=.15mm, toptitle=1mm]
...
Let's do an easy case now (before the final hard one),
\(I_z=1,\ S_z=1\). There is only one state in this case,
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{\(I_z=1,\ S_z=1\)}, titlerule=0mm, toprule=.15mm, toptitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{\(I_z=0,\ S_z=0\)}, titlerule=0mm, toprule=.15mm, toptitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{\(I_z=0,\ S_z=0\) continued}, titlerule=0mm, toprule=.15mm, toptitle=1mm]
...
These results suggest the following when dealing with degenerate \(p_1\)
and \(p_2\) cases:

\begin{itemize}
\item
  When constructing two-body interpolating operators with different
  indices \(p_1\) and \(p_2\), use the standard interpolating operators
  derived by Berkowitz and Luu
\item
  When using the same indices, one has two different \(I=0,\ S=1\)
  channels and two different \(I=1,\  S=0\) channels
\end{itemize}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Interpolating operators for equal momenta two-body excitations
(degenerate case)}, titlerule=0mm, toprule=.15mm, toptitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Energy difference at \(\mathcal{O}(V^2)\) when \(p_1\ne p_2\) but
\(\epsilon_{p_1}=\epsilon_{p_2}\)}, titlerule=0mm, toprule=.15mm, toptitle=1mm]

\begin{itemize}
\item
  \(I=1,\ S=0\ \):
  \(\ 2\epsilon_{p_1}+2V_{p_1,p_1;p_2,p_2}+\frac{2V_{-p_1,l,m,n}^2}{-\epsilon _l-\epsilon _m-\epsilon _n+\epsilon _{p_1}}-\frac{2V_{p_1,l,m,n}^2}{-\epsilon _l-\epsilon _m-\epsilon _n-\epsilon _{p_1}}
...
\item
  \(I=1,\ S=1\ \):
  \(\ 2\epsilon_{p_1}+0+\frac{2V_{-p_1,l,m,n}^2}{-\epsilon _l-\epsilon _m-\epsilon _n+\epsilon
...
\item
  \(I=1,\ S=0\):
  \(\ 2\epsilon_{p_1}+V_{p_1,p_1,p_1,p_1}+V_{p_1,p_1,p_2,p_2}+\frac{2V_{-p_1,l,m,n}^2}{-\epsilon _l-\epsilon _m-\epsilon _n+\epsilon
...
\item
  \(I=0,\ S=1\):
  \(\ 2\epsilon_{p_1}-V_{p_1,p_1,p_1,p_1}-V_{p_1,p_1,p_2,p_2}+\frac{2V_{-p_1,l,m,n}^2}{-\epsilon _l-\epsilon _m-\epsilon _n+\epsilon_{p_1}}-\frac{2V_{p_1,l,m,n}^2}{-\epsilon _l-\epsilon _m-\epsilon _n-\epsilon _{p_1}}-\frac{2
   V_{-p_1,p_2,m,n}^2}{-\epsilon _m-\epsilon _n}-\frac{2V_{-p_1,p_1,m,n}^2}{-\epsilon _m-\epsilon _n}+\frac{V_{p_1,p_1,m,n}^2}{-\epsilon _m-\epsilon _n-2 \epsilon _{p_1}}+\frac{V_{p_1,p_1,m,n}^2}{
   -\epsilon _m-\epsilon _n+2 \epsilon _{p_1}}+\frac{V_{p_1,p_1,m,n} V_{p_2,p_2,m,n}}{-\epsilon _m-\epsilon
   _n-2 \epsilon _{p_1}}+\frac{V_{p_1,p_1,m,n} V_{p_2,p_2,m,n}}{-\epsilon _m-\epsilon _n+2 \epsilon _{p_1}}\)
\end{itemize}
...
In determining these results, I used the fact that under the sum,
\(\frac{V_{\pm p_2,p_2,m,n}^2}{-\epsilon _m-\epsilon _n}=\frac{V_{\pm p_1,p_1,m,n}^2}{-\epsilon _m-\epsilon _n}\),
for example, and so on.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{Benchmarking to dQMC
simulations}\label{benchmarking-to-dqmc-simulations}

\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{assets/tube10x2.png}}
\end{center}

Data points were obtained from fitting to two-body correlators obtained
from dQMC simulations
