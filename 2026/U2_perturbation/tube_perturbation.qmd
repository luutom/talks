...
\begin{equation}
\langle\Omega|a_{p_2,\sigma'}b_{-p_1,\sigma}\tilde H_0 b^\dagger_{-p_1,\sigma}a^\dagger_{p_2,\sigma'}|\Omega\rangle=-\epsilon_{-p_1}+\epsilon_{p_2}+\mathcal{E}_{\Omega}-\frac{U}{2}\Lambda
\end{equation}

:::{.callout-note}
## Energy difference at $\mathcal{O}(V^0)$
$\therefore\quad$ the two-body excitation energy difference $=-\epsilon_{-p_1}+\epsilon_{p_2}=\epsilon_{p_1}+\epsilon_{p_2}$.
:::
...
To build all (back-to-back) two-body excitations, I first perform an intermediate step to obtain the following^[All repeated indices are summed!]
...
=a_{k,\uparrow }^{\dagger }a_{l,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }b_{-p_1,\downarrow }^{\dagger }|\Omega \rangle(V_{k,l,_2p,-n})
