...
To build all (back-to-back) two-body excitations, I first perform an intermediate step to obtain the following^[All repeated indices are summed, except for $p$!]

:::{style='font-size:60%'}
$$
\begin{equation}
\begin{split}
\tilde V b^\dagger_{-p,\uparrow}a^\dagger_{p,\uparrow}|\Omega\rangle &=a_{k,\uparrow }^{\dagger }a_{l,\downarrow }^{\dagger }b_{-m,\downarrow }^{\dagger }b_{-p,\uparrow }^{\dagger }|\Omega \rangle(-V_{k,l,-m,p})+a_{k,\uparrow }^{\dagger }a_{l,\downarrow }^{\dagger }b_{-m,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }b_{-p,\uparrow }^{\dagger }a_{p,\uparrow }^{\dagger }|\Omega \rangle(V_{k,l,-m,-n})+a_{l,\downarrow }^{\dagger }b_{-k,\downarrow }^{\dagger }|\Omega \rangle(-V_{-k,l,-p,p})+a_{l,\downarrow }^{\dagger }b_{-m,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }a_{p,\uparrow }^{\dagger }|\Omega \rangle(-V_{-p,l,-m,-n})\\
\tilde V b^\dagger_{-p,\downarrow}a^\dagger_{p,\downarrow}|\Omega\rangle &=a_{k,\uparrow }^{\dagger }a_{l,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }b_{-p,\downarrow }^{\dagger }|\Omega \rangle(V_{k,l,p,-n})+a_{k,\uparrow }^{\dagger }a_{l,\downarrow }^{\dagger }b_{-m,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }b_{-p,\downarrow }^{\dagger }a_{p,\downarrow }^{\dagger }|\Omega \rangle(V_{k,l,-m,-n})+a_{k,\uparrow }^{\dagger }b_{-n,\uparrow }^{\dagger }|\Omega \rangle(-V_{k,-p,p,-n})+a_{k,\uparrow }^{\dagger }b_{-m,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }a_{p,\downarrow }^{\dagger }|\Omega \rangle(V_{k,-p,-m,-n})\\
\tilde V a^\dagger_{-p,\uparrow}b^\dagger_{p,\uparrow}|\Omega\rangle &=a_{k,\uparrow }^{\dagger }a_{l,\downarrow }^{\dagger }b_{-m,\downarrow }^{\dagger }b_{p,\uparrow }^{\dagger }|\Omega \rangle(V_{k,l,-m,-p})+a_{k,\uparrow }^{\dagger }a_{l,\downarrow }^{\dagger }b_{-m,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }a_{-p,\uparrow }^{\dagger }b_{p,\uparrow }^{\dagger }|\Omega \rangle(V_{k,l,-m,-n})+a_{l,\downarrow }^{\dagger }b_{-k,\downarrow }^{\dagger }|\Omega \rangle(V_{-k,l,p,-p})+a_{l,\downarrow }^{\dagger }b_{-m,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }a_{-p,\uparrow }^{\dagger }|\Omega \rangle(V_{p,l,-m,-n})\\
\tilde V a^\dagger_{-p,\downarrow}b^\dagger_{p,\downarrow}|\Omega\rangle &=a_{k,\uparrow }^{\dagger }a_{l,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }b_{p,\downarrow }^{\dagger }|\Omega \rangle(-V_{k,l,-p,-n})+a_{k,\uparrow }^{\dagger }a_{l,\downarrow }^{\dagger }b_{-m,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }a_{-p,\downarrow }^{\dagger }b_{p,\downarrow }^{\dagger }|\Omega \rangle(V_{k,l,-m,-n})+a_{k,\uparrow }^{\dagger }b_{-n,\uparrow }^{\dagger }|\Omega \rangle(V_{k,p,-p,-n})+a_{k,\uparrow }^{\dagger }b_{-m,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }a_{-p,\downarrow }^{\dagger }|\Omega \rangle(-V_{k,p,-m,-n})\\
\tilde V b^\dagger_{-p,\downarrow}a^\dagger_{p,\uparrow}|\Omega\rangle &=a_{k,\uparrow }^{\dagger }a_{l,\downarrow }^{\dagger }b_{-m,\downarrow }^{\dagger }b_{-p,\downarrow }^{\dagger }|\Omega \rangle(-V_{k,l,-m,p})+a_{k,\uparrow }^{\dagger }a_{l,\downarrow }^{\dagger }b_{-m,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }b_{-p,\downarrow }^{\dagger }a_{p,\uparrow }^{\dagger }|\Omega \rangle(V_{k,l,-m,-n})+a_{k,\uparrow }^{\dagger }b_{-m,\downarrow }^{\dagger }|\Omega \rangle(V_{k,-p,-m,p})+a_{k,\uparrow }^{\dagger }b_{-m,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }a_{p,\uparrow }^{\dagger }|\Omega \rangle(V_{k,-p,-m,-n})\\
\tilde V a^\dagger_{-p,\downarrow}b^\dagger_{p,\uparrow}|\Omega\rangle &=a_{k,\uparrow }^{\dagger }a_{l,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }b_{p,\uparrow }^{\dagger }|\Omega \rangle(-V_{k,l,-p,-n})+a_{k,\uparrow }^{\dagger }a_{l,\downarrow }^{\dagger }b_{-m,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }a_{-p,\downarrow }^{\dagger }b_{p,\uparrow }^{\dagger }|\Omega \rangle(V_{k,l,-m,-n})+a_{l,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }|\Omega \rangle(-V_{p,l,-p,-n})a_{l,\downarrow }^{\dagger }b_{-m,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }a_{-p,\downarrow }^{\dagger }|\Omega \rangle(V_{p,l,-m,-n})\\
\tilde V b^\dagger_{-p,\uparrow}a^\dagger_{p,\downarrow}|\Omega\rangle &=a_{k,\uparrow }^{\dagger }a_{l,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }b_{-p,\uparrow }^{\dagger }|\Omega \rangle(V_{k,l,p,-n})+a_{k,\uparrow }^{\dagger }a_{l,\downarrow }^{\dagger }b_{-m,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }b_{-p,\uparrow }^{\dagger }a_{p,\downarrow }^{\dagger }|\Omega \rangle(V_{k,l,-m,-n})+a_{l,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }|\Omega \rangle(V_{-p,l,p,-n})+a_{l,\downarrow }^{\dagger }b_{-m,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }a_{p,\downarrow }^{\dagger }|\Omega \rangle(-V_{-p,l,-m,-n})\\
\tilde V a^\dagger_{-p,\uparrow}b^\dagger_{p,\downarrow}|\Omega\rangle &=a_{k,\uparrow }^{\dagger }a_{l,\downarrow }^{\dagger }b_{-m,\downarrow }^{\dagger }b_{p,\downarrow }^{\dagger }|\Omega \rangle(V_{k,l,-m,-p})+a_{k,\uparrow }^{\dagger }a_{l,\downarrow }^{\dagger }b_{-m,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }a_{-p,\uparrow }^{\dagger }b_{p,\downarrow }^{\dagger }|\Omega \rangle(V_{k,l,-m,-n})+a_{k,\uparrow }^{\dagger }b_{-m,\downarrow }^{\dagger }|\Omega \rangle(-V_{k,p,-m,-p})+a_{k,\uparrow }^{\dagger }b_{-m,\downarrow }^{\dagger }b_{-n,\uparrow }^{\dagger }a_{-p,\uparrow }^{\dagger }|\Omega \rangle(-V_{k,p,-m,-n})
\end{split}
\end{equation}
$${#eq-Vstate}
:::
