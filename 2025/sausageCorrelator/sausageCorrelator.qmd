...
+ From these terms I want to determine which components of the inverse fermion matrix I can compute ***without*** having to evaluate an expression of the form $D(t').V(t').V^{-1}(t).D^{-1}(t)$, since such an evaluation usually results in loss of precision^[Note that summing terms $V^{-1}.D^{-1}.U^\dagger+U.D.V$ is okay.]
