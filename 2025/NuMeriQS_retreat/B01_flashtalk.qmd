...
+ Postdoc started last October/November
  - Could not attend due to medical appointment (that could not be rescheduled in a reasonable amount of time)

+ **B01** poster: engineering spin centers in 1-D chains [arXiv:2507.18806](https://arxiv.org/abs/2507.18806)
...
+ Don't believe me?  Download this [file](https://github.com/luutom/talks/blob/main/2025/NuMeriQS_retreat/assets/t-designs.wls) and try yourself!
...
+ A ***quantum t-design*** is a finite set of $N$ quantum states that reproduces statistical properties of the uniform Haar distribution, up to $t$-th moments
  - ***state t-design***
	$$
	\int d\psi\ |\psi\rangle\langle\psi|^{\otimes t}=\sum_i^N\omega_i|\psi_i\rangle\langle\psi_i|^{\otimes t}
    $$
  - ***unitary t-design***
    $$
...
+ Is this useful for lattice gauge theories?
  - digitization of gauge fields?
  - discrete integration of gauge-invariant quantities?
  
+ Is it interesting for quantum computing?
  - Yes, in *quantum information/cryptography/tomography*
  - Interesting for NuMeriQS?
  
+ Connection to Majorana stars?
